defmodule RacingOrg.Tracker.Protobuf.SampleMode do
  @moduledoc false
...
defmodule RacingOrg.Tracker.Protobuf.RacePhase do
  @moduledoc false
...
defmodule RacingOrg.Tracker.Protobuf.MarkRounding do
  @moduledoc false
...
defmodule RacingOrg.Tracker.Protobuf.LatLon do
  @moduledoc false
...
defmodule RacingOrg.Tracker.Protobuf.LineGeometry do
  @moduledoc false

  use Protobuf, full_name: "LineGeometry", protoc_gen_elixir_version: "0.17.0", syntax: :proto3

  field(:end_a, 1, type: RacingOrg.Tracker.Protobuf.LatLon, json_name: "endA")
  field(:end_b, 2, type: RacingOrg.Tracker.Protobuf.LatLon, json_name: "endB")
end

defmodule RacingOrg.Tracker.Protobuf.CourseMark do
  @moduledoc false

  use Protobuf, full_name: "CourseMark", protoc_gen_elixir_version: "0.17.0", syntax: :proto3

  field(:code, 1, type: :string)
  field(:position, 2, type: RacingOrg.Tracker.Protobuf.LatLon)
  field(:rounding, 3, type: RacingOrg.Tracker.Protobuf.MarkRounding, enum: true)
  field(:sequence, 4, type: :uint32)
end

defmodule RacingOrg.Tracker.Protobuf.SamplingRules do
  @moduledoc false
...
defmodule RacingOrg.Tracker.Protobuf.ServerReply do
  @moduledoc false
  ...
  field(:command, 3, type: RacingOrg.Tracker.Protobuf.DeviceCommand)
end

defmodule RacingOrg.Tracker.Protobuf.DeviceCommand do
  @moduledoc false
  ...
  field(:noop, 16, type: RacingOrg.Tracker.Protobuf.NoopCommand, oneof: 0)

  field(:race_assignment, 17,
    type: RacingOrg.Tracker.Protobuf.RaceAssignment,
    json_name: "raceAssignment",
    oneof: 0
  )

  field(:route_update, 18,
    type: RacingOrg.Tracker.Protobuf.RouteUpdate,
    json_name: "routeUpdate",
    oneof: 0
  )

  field(:active_waypoint_update, 19,
    type: RacingOrg.Tracker.Protobuf.ActiveWaypointUpdate,
    json_name: "activeWaypointUpdate",
    oneof: 0
  )

  field(:cancel_assignment, 20,
    type: RacingOrg.Tracker.Protobuf.CancelAssignment,
    json_name: "cancelAssignment",
    oneof: 0
  )

  field(:manifest_verification_result, 21,
    type: RacingOrg.Tracker.Protobuf.ManifestVerificationResult,
    json_name: "manifestVerificationResult",
    oneof: 0
  )

  field(:missing_chunk_request, 22,
    type: RacingOrg.Tracker.Protobuf.MissingChunkRequest,
    json_name: "missingChunkRequest",
    oneof: 0
  )

  field(:server_time_config, 23,
    type: RacingOrg.Tracker.Protobuf.ServerTimeConfig,
...
defmodule RacingOrg.Tracker.Protobuf.RaceAssignment do
  @moduledoc false
  ...
  field(:start_line, 8, type: RacingOrg.Tracker.Protobuf.LineGeometry, json_name: "startLine")
  field(:finish_line, 9, type: RacingOrg.Tracker.Protobuf.LineGeometry, json_name: "finishLine")

  field(:course_marks, 10,
    repeated: true,
    type: RacingOrg.Tracker.Protobuf.CourseMark,
  ...
  field(:sampling_rules, 14,
    type: RacingOrg.Tracker.Protobuf.SamplingRules,
  ...
  field(:route_geometry, 16,
    repeated: true,
    type: RacingOrg.Tracker.Protobuf.LatLon,
...
defmodule RacingOrg.Tracker.Protobuf.RouteUpdate do
  @moduledoc false
...
defmodule RacingOrg.Tracker.Protobuf.ActiveWaypointUpdate do
  @moduledoc false
...
defmodule RacingOrg.Tracker.Protobuf.CancelAssignment do
  @moduledoc false
...
defmodule RacingOrg.Tracker.Protobuf.ManifestVerificationResult do
  @moduledoc false
...
defmodule RacingOrg.Tracker.Protobuf.MissingChunkRequest do
  @moduledoc false
...
defmodule RacingOrg.Tracker.Protobuf.ServerTimeConfig do
  @moduledoc false
