defmodule RagingOrg.Tracker.Protobuf.SampleMode do
  @moduledoc false
...
defmodule RagingOrg.Tracker.Protobuf.RacePhase do
  @moduledoc false
...
defmodule RagingOrg.Tracker.Protobuf.MarkRounding do
  @moduledoc false
...
defmodule RagingOrg.Tracker.Protobuf.LatLon do
  @moduledoc false

  use Protobuf, full_name: "LatLon", protoc_gen_elixir_version: "0.17.0", syntax: :proto3

  field(:latitude, 1, type: :double)
  field(:longitude, 2, type: :double)
end

defmodule RagingOrg.Tracker.Protobuf.LineGeometry do
  @moduledoc false

  use Protobuf, full_name: "LineGeometry", protoc_gen_elixir_version: "0.17.0", syntax: :proto3

  field(:end_a, 1, type: RagingOrg.Tracker.Protobuf.LatLon, json_name: "endA")
  field(:end_b, 2, type: RagingOrg.Tracker.Protobuf.LatLon, json_name: "endB")
end

defmodule RagingOrg.Tracker.Protobuf.CourseMark do
  @moduledoc false

  use Protobuf, full_name: "CourseMark", protoc_gen_elixir_version: "0.17.0", syntax: :proto3

  field(:code, 1, type: :string)
  field(:position, 2, type: RagingOrg.Tracker.Protobuf.LatLon)
  field(:rounding, 3, type: RagingOrg.Tracker.Protobuf.MarkRounding, enum: true)
  field(:sequence, 4, type: :uint32)
end

defmodule RagingOrg.Tracker.Protobuf.SamplingRules do
  @moduledoc false

  use Protobuf, full_name: "SamplingRules", protoc_gen_elixir_version: "0.17.0", syntax: :proto3

  field(:default_mode, 1,
    type: RagingOrg.Tracker.Protobuf.SampleMode,
...
defmodule RagingOrg.Tracker.Protobuf.ServerReply do
  @moduledoc false

  use Protobuf, full_name: "ServerReply", protoc_gen_elixir_version: "0.17.0", syntax: :proto3

  field(:protocol_version, 1, type: :uint32, json_name: "protocolVersion")
  field(:device_id, 2, type: :string, json_name: "deviceId")
  field(:command, 3, type: RagingOrg.Tracker.Protobuf.DeviceCommand)
end

defmodule RagingOrg.Tracker.Protobuf.DeviceCommand do
  @moduledoc false

  use Protobuf, full_name: "DeviceCommand", protoc_gen_elixir_version: "0.17.0", syntax: :proto3
  ...
  field(:noop, 16, type: RagingOrg.Tracker.Protobuf.NoopCommand, oneof: 0)

  field(:race_assignment, 17,
    type: RagingOrg.Tracker.Protobuf.RaceAssignment,
    json_name: "raceAssignment",
    oneof: 0
  )

  field(:route_update, 18,
    type: RagingOrg.Tracker.Protobuf.RouteUpdate,
    json_name: "routeUpdate",
    oneof: 0
  )

  field(:active_waypoint_update, 19,
    type: RagingOrg.Tracker.Protobuf.ActiveWaypointUpdate,
    json_name: "activeWaypointUpdate",
    oneof: 0
  )

  field(:cancel_assignment, 20,
    type: RagingOrg.Tracker.Protobuf.CancelAssignment,
    json_name: "cancelAssignment",
    oneof: 0
  )

  field(:manifest_verification_result, 21,
    type: RagingOrg.Tracker.Protobuf.ManifestVerificationResult,
    json_name: "manifestVerificationResult",
    oneof: 0
  )

  field(:missing_chunk_request, 22,
    type: RagingOrg.Tracker.Protobuf.MissingChunkRequest,
    json_name: "missingChunkRequest",
    oneof: 0
  )

  field(:server_time_config, 23,
    type: RagingOrg.Tracker.Protobuf.ServerTimeConfig,
    json_name: "serverTimeConfig",
    oneof: 0
  )
end

defmodule RagingOrg.Tracker.Protobuf.NoopCommand do
  @moduledoc false

  use Protobuf, full_name: "NoopCommand", protoc_gen_elixir_version: "0.17.0", syntax: :proto3
end

defmodule RagingOrg.Tracker.Protobuf.RaceAssignment do
  @moduledoc false

  use Protobuf, full_name: "RaceAssignment", protoc_gen_elixir_version: "0.17.0", syntax: :proto3
  ...
  field(:start_line, 8, type: RagingOrg.Tracker.Protobuf.LineGeometry, json_name: "startLine")
  field(:finish_line, 9, type: RagingOrg.Tracker.Protobuf.LineGeometry, json_name: "finishLine")

  field(:course_marks, 10,
    repeated: true,
    type: RagingOrg.Tracker.Protobuf.CourseMark,
  ...
  field(:sampling_rules, 14,
    type: RagingOrg.Tracker.Protobuf.SamplingRules,
    json_name: "samplingRules"
  )
  ...
  field(:route_geometry, 16,
    repeated: true,
    type: RagingOrg.Tracker.Protobuf.LatLon,
...
defmodule RagingOrg.Tracker.Protobuf.RouteUpdate do
  @moduledoc false

  use Protobuf, full_name: "RouteUpdate", protoc_gen_elixir_version: "0.17.0", syntax: :proto3
...
defmodule RagingOrg.Tracker.Protobuf.ActiveWaypointUpdate do
  @moduledoc false
...
defmodule RagingOrg.Tracker.Protobuf.CancelAssignment do
  @moduledoc false
...
defmodule RagingOrg.Tracker.Protobuf.ManifestVerificationResult do
  @moduledoc false
...
defmodule RagingOrg.Tracker.Protobuf.MissingChunkRequest do
  @moduledoc false
...
defmodule RagingOrg.Tracker.Protobuf.ServerTimeConfig do
  @moduledoc false
