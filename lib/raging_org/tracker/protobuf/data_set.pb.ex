defmodule RagingOrg.Tracker.Protobuf.AngleReference do
  @moduledoc false
...
defmodule RagingOrg.Tracker.Protobuf.SpeedReference do
  @moduledoc false
...
defmodule RagingOrg.Tracker.Protobuf.WindReference do
  @moduledoc false
...
defmodule RagingOrg.Tracker.Protobuf.DataSet.DataPoint do
  @moduledoc false
  ...
  field(:heading, 16, type: RagingOrg.Tracker.Protobuf.HeadingSample, oneof: 0)
  field(:speed, 17, type: RagingOrg.Tracker.Protobuf.SpeedSample, oneof: 0)
  field(:velocity, 18, type: RagingOrg.Tracker.Protobuf.VelocitySample, oneof: 0)

  field(:wind_velocity, 19,
    type: RagingOrg.Tracker.Protobuf.WindVelocitySample,
    json_name: "windVelocity",
    oneof: 0
  )

  field(:water_depth, 20,
    type: RagingOrg.Tracker.Protobuf.WaterDepthSample,
    json_name: "waterDepth",
    oneof: 0
  )

  field(:position, 21, type: RagingOrg.Tracker.Protobuf.PositionSample, oneof: 0)
  field(:tracker, 22, type: RagingOrg.Tracker.Protobuf.TrackerSample, oneof: 0)
  field(:attitude, 23, type: RagingOrg.Tracker.Protobuf.AttitudeSample, oneof: 0)
end

defmodule RagingOrg.Tracker.Protobuf.DataSet do
  @moduledoc false
  ...
  field(:data_points, 2,
    repeated: true,
    type: RagingOrg.Tracker.Protobuf.DataSet.DataPoint,
  ...
  field(:network_devices, 5,
    repeated: true,
    type: RagingOrg.Tracker.Protobuf.NetworkDevice,
    json_name: "networkDevices"
  )

  field(:ack, 6, type: RagingOrg.Tracker.Protobuf.CommandAck)
  ...
  field(:race_phase, 8,
    type: RagingOrg.Tracker.Protobuf.RacePhase,
    json_name: "racePhase",
    enum: true
  )

  field(:manifest, 9, type: RagingOrg.Tracker.Protobuf.RaceManifest)
end

defmodule RagingOrg.Tracker.Protobuf.NetworkDevice do
  @moduledoc false
...
defmodule RagingOrg.Tracker.Protobuf.CommandAck do
  @moduledoc false
...
defmodule RagingOrg.Tracker.Protobuf.VelocitySample do
  @moduledoc false
...
defmodule RagingOrg.Tracker.Protobuf.WindVelocitySample do
  @moduledoc false
  ...
  field(:wind_reference, 1,
    type: RagingOrg.Tracker.Protobuf.WindReference,
...
defmodule RagingOrg.Tracker.Protobuf.WaterDepthSample do
  @moduledoc false
...
defmodule RagingOrg.Tracker.Protobuf.PositionSample do
  @moduledoc false
...
defmodule RagingOrg.Tracker.Protobuf.TrackerSample do
  @moduledoc false

  use Protobuf, full_name: "TrackerSample", protoc_gen_elixir_version: "0.17.0", syntax: :proto3

  field(:rssi, 1, type: :sint32)
  field(:rover_data, 2, type: RagingOrg.Tracker.Protobuf.RoverData, json_name: "roverData")
end

defmodule RagingOrg.Tracker.Protobuf.AttitudeSample do
  @moduledoc false
